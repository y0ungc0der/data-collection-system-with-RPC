...
static const SERVER_ROUTINE InterfaceRPC_ServerRoutineTable[] = 
    ...
    (SERVER_ROUTINE)getOsVersionName,
    (SERVER_ROUTINE)getCurrentTime,
    (SERVER_ROUTINE)getTimeSinceStart,
    (SERVER_ROUTINE)getMemoryInfo,
    (SERVER_ROUTINE)getDrivesList,
    (SERVER_ROUTINE)getLogicalDrivesMemoryInfo,
    (SERVER_ROUTINE)getOwner,
    (SERVER_ROUTINE)getAccessRights,
    (SERVER_ROUTINE)setPKeyToServer,
    (SERVER_ROUTINE)recvEncrypSKeyFromServer
    };
